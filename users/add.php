...
<div class="content-section">
    ...
    <form id="addusers" action="usersdoadd.php" method="POST" enctype="multipart/form-data">
        <div class="form-row avatar-row">
            <div class="form-group avatar-group">
                <label for="memberAvatar" class="form-label">會員頭像</label>
...
<div class="form-section">
    ...
    <div class="form-row">
        <div class="form-group">
            ...
            <input type="password" id="memberPassword" name="password" class="form-control" minlength="6" required
                placeholder="至少6個字元">
...
<div class="form-section">
    ...
    <div class="form-row">
        <div class="form-group full-width">
            <div class="form-check">
                <input type="checkbox" id="emailNotification" name="email_notification" class="form-check-input"
                    value="1" checked>
    ...
    <div class="form-row">
        <div class="form-group full-width">
            ...
            <textarea id="memberNote" name="note" class="form-control" rows="3" placeholder="其他相關資訊..."></textarea>
        </div>
    </div>
</div>
