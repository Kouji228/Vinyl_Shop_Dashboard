        ...
        <div class="my-2 d-flex align-items-center">
            ...
            <div class="me-1-lg-1 mb-1 mb-lg-0 ms-auto">
                <div class="input-group input-group-sm">
                    ...
                    <div class="input-group-text">
                        <input name="searchType" id="searchType1" type="radio" class="form-check-input" value="title"
                            checked>
                    ...
                    <div class="time">
                        <?php if ($row["status_id"] == 0): ?>
                            <div class="btn btn-success btn-sm btn-restock" data-id="<?= $row["id"] ?>"
                                data-title="<?= $row["title"] ?>">上架</div>
                            <div class="btn btn-danger btn-sm btn-del" data-id="<?= $row["id"] ?>"
                                data-title="<?= $row["title"] ?>">刪除</div>
                        <?php else: ?>
                            <div class="btn btn-danger btn-sm btn-remove" data-id="<?= $row["id"] ?>"
                                data-title="<?= $row["title"] ?>">下架</div>
